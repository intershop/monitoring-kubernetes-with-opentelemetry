...
runTests() {
  ...
  collectorDaemonsetOpsteamExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.exporters.otlp_http/opsteam')
  ...
  collectorDaemonsetDevteam1ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.exporters.otlp_http/devteam1')
  ...
  collectorDaemonsetDevteam2ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.exporters.otlp_http/devteam2')
  ...
  collectorDaemonsetOpsteamPipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.service.pipelines.logs/opsteam.exporters[]' | yq 'select("otlp_http/opsteam")')
  ...
  collectorDaemonsetDevteam1PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.service.pipelines.logs/devteam1.exporters[]' | yq 'select("otlp_http/devteam1")')
  ...
  collectorDaemonsetDevteam2PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDaemonsetName}'")).spec.config' | yq '.service.pipelines.logs/devteam2.exporters[]' | yq 'select("otlp_http/devteam2")')
  ...
  collectorDeploymentReceiverOpsteamExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.exporters.otlp_http/opsteam')
  ...
  collectorDeploymentReceiverDevteam1ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.exporters.otlp_http/devteam1')
  ...
  collectorDeploymentReceiverDevteam2ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.exporters.otlp_http/devteam2')
  ...
  collectorDeploymentSamplerOpsteamExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.exporters.otlp_http/opsteam')
  ...
  collectorDeploymentSamplerDevteam1ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.exporters.otlp_http/devteam1')
  ...
  collectorDeploymentSamplerDevteam2ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.exporters.otlp_http/devteam2')
  ...
  collectorDeploymentReceiverOpsteamPipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.service.pipelines.metrics/opsteam.exporters[]' | yq 'select("otlp_http/opsteam")')
  ...
  collectorDeploymentReceiverDevteam1PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.service.pipelines.metrics/devteam1.exporters[]' | yq 'select("otlp_http/devteam1")')
  ...
  collectorDeploymentReceiverDevteam2PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentReceiverName}'")).spec.config' | yq '.service.pipelines.metrics/devteam2.exporters[]' | yq 'select("otlp_http/devteam2")')
  ...
  collectorDeploymentSamplerOpsteamPipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.service.pipelines.traces/opsteam.exporters[]' | yq 'select("otlp_http/opsteam")')
  ...
  collectorDeploymentSamplerDevteam1PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.service.pipelines.traces/devteam1.exporters[]' | yq 'select("otlp_http/devteam1")')
  ...
  collectorDeploymentSamplerDevteam2PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorDeploymentSamplerName}'")).spec.config' | yq '.service.pipelines.traces/devteam2.exporters[]' | yq 'select("otlp_http/devteam2")')
  ...
  # OTLP exporter for opsteam should be configured
  collectorStatefulsetOpsteamExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.exporters.otlp_http/opsteam')
  ...
  # OTLP exporter for devteam1 should be configured
  collectorStatefulsetDevteam1ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.exporters.otlp_http/devteam1')
  ...
  # OTLP exporter for devteam2 should not be configured
  collectorStatefulsetDevteam2ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.exporters.otlp_http/devteam2')
  ...
  # Pipeline otlp exporter for opsteam should be configured
  collectorStatefulsetOpsteamPipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.service.pipelines.metrics/opsteam.exporters[]' | yq 'select("otlp_http/opsteam")')
  ...
  # Pipeline otlp exporter for devteam1 should be configured
  collectorStatefulsetDevteam1PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.service.pipelines.metrics/devteam1.exporters[]' | yq 'select("otlp_http/devteam1")')
  ...
  # Pipeline otlp exporter for devteam2 should not be configured
  collectorStatefulsetDevteam2PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorStatefulsetName}'")).spec.config' | yq '.service.pipelines.metrics/devteam2.exporters[]' | yq 'select("otlp_http/devteam2")')
  ...
  # OTLP exporter for opsteam should be configured
  collectorSingletonOpsteamExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.exporters.otlp_http/opsteam')
  ...
  collectorSingletonDevteam1ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.exporters.otlp_http/devteam1')
  ...
  # OTLP exporter for devteam2 should not be configured
  collectorSingletonDevteam2ExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.exporters.otlp_http/devteam2')
  ...
  # Pipeline otlp exporter for opsteam should be configured
  collectorSingletonOpsteamPipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.service.pipelines.logs/opsteam.exporters[]' | yq 'select("otlp_http/opsteam")')
  ...
  # Pipeline otlp exporter for devteam1 should be configured
  collectorSingletonDevteam1PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.service.pipelines.logs/devteam1.exporters[]' | yq 'select("otlp_http/devteam1")')
  ...
  # Pipeline otlp exporter for devteam2 should not be configured
  collectorSingletonDevteam2PipelineExporterOtlpConfigCheck=$(echo "$helmTemplate" | yq 'select((.kind == "OpenTelemetryCollector") and (.metadata.name == "'${collectorSingletonName}'")).spec.config' | yq '.service.pipelines.logs/devteam2.exporters[]' | yq 'select("otlp_http/devteam2")')
